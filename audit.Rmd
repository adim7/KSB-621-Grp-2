...
events_subset_trans <- events1 %>%
  ...
  mutate(EventStartTimeSetup  = hms(as.numeric(EventStartTimeSetup)), # convert from chr to time format
         EventStopTimeBreakdown  = hms(as.numeric(EventStopTimeBreakdown))); events_subset_trans
...
# view the rest of the observations with correct format
